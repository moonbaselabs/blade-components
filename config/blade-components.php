...
return [
    ...
    'components' => [
        ...
        'badge' => [
            ...
            'themes' => [
                'default' => 'inline-flex items-center rounded-full font-medium bg-gray-100 text-gray-800',
                'red' => 'inline-flex items-center rounded-full font-medium bg-red-100 text-red-800',
                'yellow' => 'inline-flex items-center rounded-full font-medium bg-yellow-100 text-yellow-800',
                'green' => 'inline-flex items-center rounded-full font-medium bg-green-100 text-green-800',
                'blue' => 'inline-flex items-center rounded-full font-medium bg-blue-100 text-blue-800',
                'indigo' => 'inline-flex items-center rounded-full font-medium bg-indigo-100 text-indigo-800',
                'purple' => 'inline-flex items-center rounded-full font-medium bg-purple-100 text-purple-800',
                'pink' => 'inline-flex items-center rounded-full font-medium bg-pink-100 text-pink-800',
            ],
        ],
